      ...
      <Router>
        <div className="App" ref={this.appRef} onScroll={this.handleScroll}>
          ...
          <div className="App__content">
                ...
                <div>
                  <div className='App__nav'>
                    ...
                    {/* <div className="App__promo">
                      <KubeconLogo size="22" />
                      Spring 2025 special offer! Get a <strong>50% discount</strong> on all movies today!
                    </div> */}

                    <Link className="button" role="button" to="/admin/rentals-history">
            ...
            <Switch>
              <Route path="/admin/rentals-history">
              <div className='App__nav'>
